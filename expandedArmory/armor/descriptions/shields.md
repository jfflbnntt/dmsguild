...
* **Small Shield.** A small lightweight shield usually round and held extended from the body by one hand. An improvised shield is usually only effective as a small shield. Anyone with the light armor proficiency can use a light shield.
...
* **Large Shield.** A tall shield that is strapped to the forearm and supported by resting the bottom on the ground when not moving. It is frequently used on battlefields as a mobile piece of cover for archers or soldiers in a shield wall. Anyone with the heavy armor proficiency can also use heavy shields, however due to the **oversized** property it cannot be used while mounted and small creatures must use two hands when wielding it.
